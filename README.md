...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lumispy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12337&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lumispy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lumispy` can be installed with:

```
conda install lumispy
```

It is possible to list all of the versions of `lumispy` available on your platform with:
